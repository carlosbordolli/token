...
public class ActividadMapper {
    ...
    public ActividadDTO toDto(Actividad entity) {
        ...
        return ActividadDTO.builder()
                ...
                .fecAperturaInscripcion(entity.getFecAperturaInscripcion())
                .fecCierreInscripcion(entity.getFecCierreInscripcion())
    ...
    public static Actividad toEntity(ActividadDTO dto, TipoActividad tipo, AuxAdministrativo aux, Espacio espacio) {
        ...
        return Actividad.builder()
                ...
                .fecAperturaInscripcion(dto.getFecAperturaInscripcion())
                .fecCierreInscripcion(dto.getFecCierreInscripcion())
