...
public class PagoDTO {
    ...
    @Schema(description = "Fecha de cobro", example = "31/12/2024")
    private LocalDate fechaCobro;

    @Schema(description = "Monto del pago", example = "1553,75")
    private BigDecimal monto;

    @Schema(description = "Forma de cobro", example = "EFECTIVO")
    private String formaCobro;

    @Schema(description = "Identificador interno de la actividad", example = "5")
    private Integer idActividad;

    @Schema(description = "Identificador interno de la reserva", example = "2")
