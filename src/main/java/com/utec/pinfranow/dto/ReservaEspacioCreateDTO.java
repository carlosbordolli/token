...
@Schema(name = "ReservaEspacioDTO", description = "Representa una reserva de espacio para una actividad")
public class ReservaEspacioCreateDTO {
    ...
    @Schema(description = "Fecha de vencimiento de la seña", accessMode = Schema.AccessMode.READ_ONLY)
